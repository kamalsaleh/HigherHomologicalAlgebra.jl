...
@InstallGlobalFunction( ADD_FUNCTIONS_OF_HOMOMORPHISM_STRUCTURE_TO_HOMOTOPY_CATEGORY_BY_COCHAINS,
  function ( homotopy_category )
    ...
    elseif (IsCategoryOfRows( range_cat ))
    ...
    if (can_be_equipped_with_hom_structure_over_abelian_category)
      ...
      AddInterpretMorphismFromDistinguishedObjectToHomomorphismStructureAsMorphism( homotopy_category,
        function ( homotopy_category, B, C, ell )
          ...
          ell = CallFuncListAtRuntime( CreateComplexMorphism, [ distinguished_object, [ unwrap_morphism_in_abelian_category( PreCompose( range_cat, ell, iota ) ) ], 0, hom_BC ] );
          
          return CallFuncListAtRuntime( MorphismConstructor,
                      [ homotopy_category,
                        B,

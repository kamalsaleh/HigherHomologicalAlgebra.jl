...
@InstallMethod( HomotopyCategoryByChains,
  ...
  function( CAP_NAMED_ARGUMENTS, cat )
    ...
    coch_homotopy_cat = HomotopyCategoryByCochains( cat; overhead = overhead );
    ch_cat = ComplexesCategoryByChains( cat; overhead = overhead );
  ...
  function( CAP_NAMED_ARGUMENTS, cat )
    ...
    homotopy_category = QuotientCategory(
                           @rec( name = name,
                                ...
                                underlying_category = ComplexesCategoryByCochains( cat; overhead = overhead ),
                                category_filter = IsHomotopyCategoryByCochains,
                                category_object_filter = IsHomotopyCategoryByCochainsObject,
                                category_morphism_filter = IsHomotopyCategoryByCochainsMorphism ); FinalizeCategory = false, overhead = overhead );

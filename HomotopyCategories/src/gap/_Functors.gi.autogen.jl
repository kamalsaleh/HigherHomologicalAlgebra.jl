...
function( homotopy_category, n )
  ...
  name = @Concatenation( StringGAP( n ), "-th homology functor" );
...
function( homotopy_category, n )
  ...
  name = @Concatenation( StringGAP( n ), "-th cohomology functor" );
...
function( homotopy_category, n )
  ...
  name = @Concatenation( "Shift by ", StringGAP( n ), " autoequivalence" );
...
function( homotopy_category, n )
  ...
  name = @Concatenation( "Unsigned Shift by ", StringGAP( n ), " autoequivalence on " );
...
@InstallMethod( EmbeddingFunctorInHomotopyCategory,
  ...
  function( cat )
    ...
    if (!( HasIsAdditiveCategory( cat ) && IsAdditiveCategory( cat ) ))
...
@InstallMethod( LocalizationFunctorByProjectiveObjects,
  ...
  function( homotopy_category )
    ...
    if (@not IsAbelianCategoryWithComputableEnoughProjectives( cat ))
    ...
    if (IsChainComplexCategory( UnderlyingCategory( homotopy_category ) ))
...
functor =
  [
    ...
    function( homotopy_cat, homotopy_cat_projs )
      ...
      if (@not ValueGlobal( "HasFullSubcategoryGeneratedByProjectiveObjects" )( cat ))
        return false;
      end;
      if (@not IsIdenticalObj( projs, ValueGlobal( "FullSubcategoryGeneratedByProjectiveObjects" )( cat ) ))
        return false;
      end;
      return true;
    end,
...
##
@InstallMethod( LocalizationFunctorByProjectiveObjects,
              [ IsCapCategory && IsAbelianCategory ],
  function( C )
    local Ho_C, I, L;
...
functor =
  [
    ...
    function( homotopy_cat, homotopy_cat_projs )
      ...
      cat = DefiningCategory( homotopy_cat );
      projs = DefiningCategory( homotopy_cat_projs );
      if (@not ValueGlobal( "HasFullSubcategoryGeneratedByInjectiveObjects" )( cat ))
        return false;
      end;
      if (@not IsIdenticalObj( projs, ValueGlobal( "FullSubcategoryGeneratedByInjectiveObjects" )( cat ) ))
        return false;
      end;
      return true;
    end,
...
@InstallMethod( LocalizationFunctorByInjectiveObjects,
  ...
  function( homotopy_category )
    ...
    if (@not IsAbelianCategoryWithComputableEnoughInjectives( cat ))
...
@InstallMethod( ExtendFunctorMethodToHomotopyCategories,
  ...
  function( E )
    ...
    ExtendFunctorMethod(
      E,
      category -> IsHomotopyCategory( category ) && IsChainComplexCategory( UnderlyingCategory( category ) ),
      DefiningCategory,
    ...
    ExtendFunctorMethod(
      E,
      category -> IsHomotopyCategory( category ) && IsCochainComplexesCategory( UnderlyingCategory( category ) ),
      DefiningCategory,

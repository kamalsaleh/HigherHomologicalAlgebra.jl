...
#! @Arguments C
@DeclareFilter( "IsComplexesCategory", IsCapCategory );

#! @Description
#!  GAP-categories of the chain complexes category.
#! @Arguments C
@DeclareFilter( "IsComplexesCategoryByChains", IsComplexesCategory );

#! @Description
#!  GAP-category of the cochain complexes category.
#! @Arguments C
@DeclareFilter( "IsComplexesCategoryByCochains", IsComplexesCategory );

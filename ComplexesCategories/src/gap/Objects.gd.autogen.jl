...
#! @Arguments C
@DeclareFilter( "IsChainOrCochainComplex", IsCapCategoryObject );

#! @Description
#!  GAP-categories of the chain complexes.
#! @Arguments C
@DeclareFilter( "IsChainComplex", IsChainOrCochainComplex );

#! @Description
#!  GAP-categories of the cochain complexes.
#! @Arguments C
@DeclareFilter( "IsCochainComplex", IsChainOrCochainComplex );
...
@BindGlobal( "ChainComplex", CreateComplex );
@BindGlobal( "CochainComplex", CreateComplex );

...
#! @Arguments phi
@DeclareFilter( "IsChainOrCochainMorphism", IsCapCategoryMorphism );

#! @Description
#!  GAP-categories of the chain complex morphisms.
#! @Arguments phi
@DeclareFilter( "IsChainMorphism", IsChainOrCochainMorphism );

#! @Description
#!  GAP-categories of the cochain complex morphisms.
#! @Arguments phi
@DeclareFilter( "IsCochainMorphism", IsChainOrCochainMorphism );

...
julia> objects = [ [ "A1", [ -2, 2 ], "A_[1]" ], [ "A2", [ -2, 2 ], "A_[2]" ], [ "A3", [ -2, 2 ], "A_[3]" ], [ "A4", [ -2, 2 ], "A_[4]" ],
                         [ "B1", [ -2, 2 ], "B_[1]" ], [ "B2", [ -2, 2 ], "B_[2]" ], [ "B3", [ -2, 2 ], "B_[3]" ], [ "B4", [ -2, 2 ], "B_[4]" ] ];

julia> morphisms = [ [ "dA_1", [ 1, 2 ], 0, [ -2, 2 ], "\\partial_[A]^[1]" ],
...
julia> relations = [ [ "PreCompose( dA_1, dA_2 )", 1 ],
...
julia> cochains_Aoid = ComplexesCategoryByCochains( Aoid );

julia> cochains_cochains_Aoid = ComplexesCategoryByCochains( cochains_Aoid );

julia> cochains_bicomplexes_Aoid = BicomplexesCategoryByCochains( Aoid );

julia> @Assert( 0, IsIdenticalObj( cochains_cochains_Aoid, ModelingCategory( cochains_bicomplexes_Aoid ) ) )

julia> A1 = CreateComplex( cochains_Aoid, List( [ oid.dA1_m2, oid.dA1_m1, oid.dA1_0, oid.dA1_1 ], m -> m / Aoid ), -2 );

julia> A2 = CreateComplex( cochains_Aoid, List( [ oid.dA2_m2, oid.dA2_m1, oid.dA2_0, oid.dA2_1 ], m -> m / Aoid ), -2 );

julia> A3 = CreateComplex( cochains_Aoid, List( [ oid.dA3_m2, oid.dA3_m1, oid.dA3_0, oid.dA3_1 ], m -> m / Aoid ), -2 );

julia> A4 = CreateComplex( cochains_Aoid, List( [ oid.dA4_m2, oid.dA4_m1, oid.dA4_0, oid.dA4_1 ], m -> m / Aoid ), -2 );

julia> B1 = CreateComplex( cochains_Aoid, List( [ oid.dB1_m2, oid.dB1_m1, oid.dB1_0, oid.dB1_1 ], m -> m / Aoid ), -2 );

julia> B2 = CreateComplex( cochains_Aoid, List( [ oid.dB2_m2, oid.dB2_m1, oid.dB2_0, oid.dB2_1 ], m -> m / Aoid ), -2 );

julia> B3 = CreateComplex( cochains_Aoid, List( [ oid.dB3_m2, oid.dB3_m1, oid.dB3_0, oid.dB3_1 ], m -> m / Aoid ), -2 );

julia> B4 = CreateComplex( cochains_Aoid, List( [ oid.dB4_m2, oid.dB4_m1, oid.dB4_0, oid.dB4_1 ], m -> m / Aoid ), -2 );

julia> dA_1 = CreateComplexMorphism( cochains_Aoid, A1, List( [ oid.dA_1_m2, oid.dA_1_m1, oid.dA_1_0, oid.dA_1_1, oid.dA_1_2 ], m -> m / Aoid ), -2, A2 );

julia> dA_2 = CreateComplexMorphism( cochains_Aoid, A2, List( [ oid.dA_2_m2, oid.dA_2_m1, oid.dA_2_0, oid.dA_2_1, oid.dA_2_2 ], m -> m / Aoid ), -2, A3 );

julia> dA_3 = CreateComplexMorphism( cochains_Aoid, A3, List( [ oid.dA_3_m2, oid.dA_3_m1, oid.dA_3_0, oid.dA_3_1, oid.dA_3_2 ], m -> m / Aoid ), -2, A4 );

julia> dB_1 = CreateComplexMorphism( cochains_Aoid, B1, List( [ oid.dB_1_m2, oid.dB_1_m1, oid.dB_1_0, oid.dB_1_1, oid.dB_1_2 ], m -> m / Aoid ), -2, B2 );

julia> dB_2 = CreateComplexMorphism( cochains_Aoid, B2, List( [ oid.dB_2_m2, oid.dB_2_m1, oid.dB_2_0, oid.dB_2_1, oid.dB_2_2 ], m -> m / Aoid ), -2, B3 );

julia> dB_3 = CreateComplexMorphism( cochains_Aoid, B3, List( [ oid.dB_3_m2, oid.dB_3_m1, oid.dB_3_0, oid.dB_3_1, oid.dB_3_2 ], m -> m / Aoid ), -2, B4 );

julia> f1 = CreateComplexMorphism( cochains_Aoid, A1, List( [ oid.f1_m2, oid.f1_m1, oid.f1_0, oid.f1_1, oid.f1_2 ], m -> m / Aoid ), -2, B1 );

julia> f2 = CreateComplexMorphism( cochains_Aoid, A2, List( [ oid.f2_m2, oid.f2_m1, oid.f2_0, oid.f2_1, oid.f2_2 ], m -> m / Aoid ), -2, B2 );

julia> f3 = CreateComplexMorphism( cochains_Aoid, A3, List( [ oid.f3_m2, oid.f3_m1, oid.f3_0, oid.f3_1, oid.f3_2 ], m -> m / Aoid ), -2, B3 );

julia> f4 = CreateComplexMorphism( cochains_Aoid, A4, List( [ oid.f4_m2, oid.f4_m1, oid.f4_0, oid.f4_1, oid.f4_2 ], m -> m / Aoid ), -2, B4 );

julia> A = CreateComplex( cochains_cochains_Aoid, [ dA_1, dA_2, dA_3 ], 1 );

julia> B = CreateComplex( cochains_cochains_Aoid, [ dB_1, dB_2, dB_3 ], 1 );

julia> f = CreateComplexMorphism( cochains_cochains_Aoid, A, [ f1, f2, f3, f4 ], 1, B );

julia> @Assert( 0, ForAll( [ A, B, f ], IsWellDefined ) )

julia> A = CreateBicomplex( cochains_bicomplexes_Aoid, A );

julia> B = CreateBicomplex( cochains_bicomplexes_Aoid, B );

julia> f = CreateBicomplexMorphism( cochains_bicomplexes_Aoid, f );

julia> @Assert( 0, ForAll( [ A, B, f ], IsWellDefined ) )

julia> total_f = TotalComplexFunctorial( TotalComplex(A), f, TotalComplex(B) );

julia> @Assert( 0, IsWellDefined( total_f ) )

julia> chains_bicomplexes_Aoid = BicomplexesCategoryByChains( Aoid );

julia> A = CreateBicomplex( chains_bicomplexes_Aoid, A );

julia> B = CreateBicomplex( chains_bicomplexes_Aoid, B );

julia> f = CreateBicomplexMorphism( chains_bicomplexes_Aoid, f );

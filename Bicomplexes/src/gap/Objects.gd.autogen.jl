...
#! @Arguments C
@DeclareFilter( "IsChainOrCochainBicomplex", IsCapCategoryObject );

#! @Description
#!  GAP-categories of the chain complexes.
#! @Arguments C
@DeclareFilter( "IsCochainBicomplex", IsChainOrCochainBicomplex );

#! @Description
#!  GAP-categories of the cochain complexes.
#! @Arguments C
@DeclareFilter( "IsChainBicomplex", IsChainOrCochainBicomplex );

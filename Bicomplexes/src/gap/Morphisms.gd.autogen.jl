...
#! @Arguments phi
@DeclareFilter( "IsChainOrCochainBicomplexMorphism", IsCapCategoryMorphism );

#! @Description
#!  GAP-categories of the chain complex morphisms.
#! @Arguments phi
@DeclareFilter( "IsCochainBicomplexMorphism", IsChainOrCochainBicomplexMorphism );

#! @Description
#!  GAP-categories of the cochain complex morphisms.
#! @Arguments phi
@DeclareFilter( "IsChainBicomplexMorphism", IsChainOrCochainBicomplexMorphism );

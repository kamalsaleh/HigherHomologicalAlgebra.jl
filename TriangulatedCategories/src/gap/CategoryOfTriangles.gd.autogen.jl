...
@DeclareFilter( "IsCategoryOfExactTriangles", IsCapCategory );

#! @Description
#! The &GAP; category for exact triangles.
#! @Arguments triangle
#! @Returns true or false
@DeclareFilter( "IsCategoryOfExactTrianglesObject", IsCapCategoryObject );

#! @Description
#! The &GAP; category for morphism of exact triangles
#! @Arguments mu
#! @Returns true or false
@DeclareFilter( "IsCategoryOfExactTrianglesMorphism", IsCapCategoryMorphism );
